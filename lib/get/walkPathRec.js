...
function getPath(
   ...
   // if nothing found in cache, add paths to set of abs and rel missing paths
    if (curNode === undefined) {
        ...
        return materialize ? { $type: 'atom' } : undefined;
    }
   ...
   if (type === "ref") {
      ...
      // if refTarget comes back undefined, build a relative missing path
      // and short-circuit
